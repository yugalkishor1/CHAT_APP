...
function Setavatar() {
    ...
    try {
      ...
      if(selectedAvatar===undefined){
        ...
        if(response.data.isSet){
          ...
          (function notify(){
            toast.success("avatar added to your Profile")
          })()
  ...
  return (
    ...
    <>
          ...
          <button className='border rounded border-blue text-white bg-red-600 p-2 hover:bg-red-800 cursor-pointer mt-4' onClick={setProfilePicture}>Set as Profile picture</button>
        </div>
